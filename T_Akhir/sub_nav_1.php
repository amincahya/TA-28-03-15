<?php
			/* 	echo "<ul>
				...
				echo  "</li>
						...
						<li class='logout'><a href='act.php?p=p_logout' class='logout'>logout</a></li>"; */
	...
	if($pub=="p_profil")
	{
				 ...
				 echo "<ul>
                            <li><a href='#' class='active'>Team Info</a></li>
	...
	{		
				...
				echo "</li>
					  <li class='reports'><a href='act.php?p=p_cust' class='reports'>Customer</a></li>
				      <li class='tools'><a href='act.php?p=p_report' class='tools'>Report</a></li>
					  <li class='logout'><a href='act.php?p=p_logout' class='logout'>logout</a>
					  </li>";
